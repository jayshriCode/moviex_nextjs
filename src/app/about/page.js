...
const About = () => {
  return (
    <>
      ...
      <div className="container px-14 mb-3">
        ...
        <div className="flex flex-col mt-1">
            ...
            <div className="flex flex-wrap justify-center text-center mb-5">
                    <div className="w-full  px-4">
                        ...
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rerum laborum eveniet, molestiae voluptatem dolor vero. Excepturi necessitatibus dolores nostrum rerum officia eos maiores placeat? Voluptas corrupti accusantium recusandae quia eveniet.
                        </p>
                    </div>
                </div>
            <div className="flex flex-wrap justify-center text-center mb-5">
                    <div className="w-full  px-4">
                        ...
                        <p className="text-gray-700 text-lg font-light">
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Esse, cupiditate accusamus praesentium ipsa, sit tempore voluptate nulla similique, reiciendis quos dolores voluptas harum delectus ullam veniam earum quia eaque sapiente!
                        </p>
                    </div>
                </div>
